...
def branchBottleNeck(channel_in, channel_out, kernel_size, stride):
    ...
    return nn.Sequential(
        ...
        nn.Conv2d(middle_channel, middle_channel, kernel_size=kernel_size, stride=stride, padding=1),
        nn.BatchNorm2d(middle_channel),
        nn.ReLU(),
...
def _resnet(arch, block, layers,  pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        # pretrained_dict = {str.replace(k,'module.',''): v for k,v in pretrained_dict['state_dict'].items()}
